            ...
            <aside id='rightside'>
                <div class='side1'>
                        ...
                        <!-- 로그인 실패 : 메세지 처리 
                            ...
                            <%                     
                            // 쿠키에 저장된 아이디가 있다면 아이디를 텍스트 필드에 value 값으로 출력
                ...
                %>
                    ...
                    <div class='loginbox'>
                        <div id='login'>
   						...
   						<form action="gogreenLogin.jsp" method="post">
                            <input type="text" name="userid" id="userpw" placeholder='ID를 입력해주세요.' required="required" value = <%=userid %>>
                    ...
                    <div id='info'>
                    	<!--  선택되었을 때만 서버에 넘어가고 선택안하고 값을 출력해보면 null이 출력 -->
                        <input type ="checkbox" name = "save_check" value="Y" <%=!userid.equals("")? "checked" : ""%>>아이디저장하기<br>
                        <a href="">회원가입</a><br>
                        <a href="">ID찾기</a>
                        <a href="">PW찾기</a>
                    </div>
